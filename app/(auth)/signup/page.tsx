export default function SignupPage() {
  return (
    <div className="min-h-screen bg-surface flex items-center justify-center px-4 relative overflow-hidden">
      {/* Ambient glow */}
      <div
        className="absolute top-0 right-0 w-[400px] h-[400px] opacity-8 pointer-events-none"
        style={{ background: 'radial-gradient(circle, #7c6af7 0%, transparent 70%)', opacity: 0.08 }}
      />
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <p className="label-micro text-primary mb-3">Join the experience</p>
        <h1 className="font-editorial text-display-sm text-on_surface mb-10 leading-tight">
          Your first event<br />is waiting.
        </h1>
        ...
        <p className="mt-6 text-center text-sm text-on_surface_variant">
          Already a member?{' '}
          <a href="/login" className="text-primary hover:text-primary_container transition-colors font-medium">
            Sign in
          </a>
        </p>
      </div>
